 ...
 */
public class ECAddress implements Serializable, Address {
...
//    private String userAddress;
     ...
     * @return The address.
     */
    public static ECAddress fromBytes(byte[] address) {
        return new ECAddress().setValue(new String(address, StandardCharsets.US_ASCII));
    }

    public static ECAddress fromHexBytes(byte[] address) {
        return new ECAddress().setValue(Encoding.HEX.encode(address));
    }
     ...
     * @return The address.
     */
    public static ECAddress fromString(String humanReadableAddress) {
        return new ECAddress().setValue(humanReadableAddress);
    }

    public static ECAddress randomPrivate(AddressType addressType) {
     ...
     */
    public ECAddress(String humanReadableAddress) {
     ...
     */
    protected ECAddress setValue(String value) {

...
public class SigningClientTest extends AbstractClientTest {
    ...
    protected final OfflineWalletdClientImpl offlineWalletdClient = new TestOfflineWalletdClientImpl();
    ...
    public void testChainCommit() {
        ...
        Chain chain = chain();
        Address publicAddress = new ECAddress(EC_PUBLIC_ADDRESS);
    ...
    public void testChainReveal() {
        ...
        String composeChainReveal = offlineWalletdClient.composeChainReveal(chain);
    ...
    public void testEntryReveal() {
        ...
        String composeEntryReveal = offlineWalletdClient.composeEntryReveal(entry);

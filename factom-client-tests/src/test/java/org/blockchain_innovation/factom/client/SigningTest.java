...
public class SigningTest extends AbstractClientTest {
    ...
    public void testChain() {
        Chain chain = chain();
        CommitAndRevealChainResponse commitAndRevealChain = entryOfflineSigningClient.commitAndRevealChain(chain, EC_PUBLIC_KEY, EC_SECRET_KEY).join();
    ...
    public void testComposeChain() {
        ...
        String composeChainCommit = entryOfflineSigningClient.composeChainCommit(chain, EC_PUBLIC_KEY, EC_SECRET_KEY);
    ...
    public void testEntry() {
        Entry entry = entry();
        CommitAndRevealEntryResponse commitAndRevealChain = entryOfflineSigningClient.commitAndRevealEntry(entry, EC_PUBLIC_KEY, EC_SECRET_KEY).join();
    ...
    public void testComposeEntry() {
        ...
        String composeEntryCommit = entryOfflineSigningClient.composeEntryCommit(entry, EC_PUBLIC_KEY, EC_SECRET_KEY);

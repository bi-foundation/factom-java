...
public class SigningTest extends AbstractClientTest {
    ...
    @Test
    public void test() {
        FactomResponse<RevealResponse> join = factomdClient.revealChain("006c487fe8cc4830920730ded69ba6b4d428bdd62aa3727103cc95614fe47ce64d00120004235169190004616263640004313233343132333461626364").join();
        assertValidResponse(join);
    }
    @Test
    public void test2() {
        FactomResponse<CommitChainResponse> join = factomdClient.commitChain("").join();
        assertValidResponse(join);
    }
    ...
    public void testChain() {
        Chain chain = chain();
        CommitAndRevealChainResponse commitAndRevealChain = entryOfflineSigningClient.commitAndRevealChain(chain, EC_PUBLIC_ADDRESS, EC_SECRET_ADDRESS).join();
    ...
    public void testComposeChain() {
        ...
        String composeChainCommit = entryOfflineSigningClient.composeChainCommit(chain, EC_PUBLIC_ADDRESS, EC_SECRET_ADDRESS);
        ...
        String composeChainReveal = entryOfflineSigningClient.composeChainReveal(chain);
    ...
    public void testEntry() {
        Entry entry = entry();
        CommitAndRevealEntryResponse commitAndRevealChain = entryOfflineSigningClient.commitAndRevealEntry(entry, EC_PUBLIC_ADDRESS, EC_SECRET_ADDRESS).join();
    ...
    public void testComposeEntry() {
        ...
        String composeEntryCommit = entryOfflineSigningClient.composeEntryCommit(entry, EC_PUBLIC_ADDRESS, EC_SECRET_ADDRESS);
        ...
        String composeEntryReveal = entryOfflineSigningClient.composeEntryReveal(entry);

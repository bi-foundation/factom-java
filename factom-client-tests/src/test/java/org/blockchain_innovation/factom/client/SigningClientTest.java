...
public class SigningClientTest extends AbstractClientTest {
    ...
    public void testChainCommit() {
        ...
        String composeChainCommit = signingClient.composeChainCommit(chain, EC_PUBLIC_KEY, EC_SECRET_KEY);
    ...
    public void testEntryCommit() {
        ...
        String composeEntryCommit = signingClient.composeEntryCommit(entry, EC_PUBLIC_KEY, EC_SECRET_KEY);
